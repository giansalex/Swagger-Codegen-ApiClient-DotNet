...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CliOption :  IEquatable<CliOption>, IValidatableObject
    {
        /// <summary>
        ...
        public CliOption(string OptionName = default(string), string Description = default(string), string Type = default(string), string _Default = default(string), Dictionary<string, string> _Enum = default(Dictionary<string, string>))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CliOption);
        }

        /// <summary>
        /// Returns true if CliOption instances are equal
        /// </summary>
        /// <param name="other">Instance of CliOption to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CliOption other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
