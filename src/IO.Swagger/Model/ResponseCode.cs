...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResponseCode :  IEquatable<ResponseCode>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseCode" /> class.
        /// </summary>
        /// <param name="Code">File download code.</param>
        /// <param name="Link">URL for fetching the generated client.</param>
        public ResponseCode(string Code = default(string), string Link = default(string))
        {
            this.Code = Code;
            this.Link = Link;
        }
        ...
        /// <summary>
        /// Returns true if ResponseCode instances are equal
        /// </summary>
        /// <param name="other">Instance of ResponseCode to be compared</param>
        /// <returns>Boolean</returns>
